    ...
    <View style={{ flex: 1, backgroundColor: 'blue' }}>
      ...
      <View style={{ backgroundColor: 'white', borderTopRightRadius: 30, borderTopLeftRadius: 20, minHeight: '100%' }}>
        <ScrollView showsVerticalScrollIndicator={false} >
          <Text style={{ color: 'black', textAlign: 'center', fontSize: 30, fontWeight: 600, marginTop: 50 }}>Ulasan</Text>
          <Text style={{ color: '#666666', textAlign: 'center', fontSize: 20, fontWeight: 600, marginBottom: 30 }}><FontAwesome name={'star'} size={20} color={'#F4BF35'} /> {`${rataRata} (${ratings.length})`}</Text>
