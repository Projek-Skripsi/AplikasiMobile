import { Alert, View, Text, StatusBar, StyleSheet, Image, TextInput, TouchableOpacity, Modal, Pressable } from 'react-native'
...
export default function Login ({ navigation }) {
  ...
  function onResetPassword () {
    // await to firebase reset password
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ backgroundColor: 'blue' }}>
        ...
        <View style={{ position: 'relative', top: -80, backgroundColor: 'white', borderTopRightRadius: 30, borderTopLeftRadius: 20, marginTop: 50, height: '250%' }}>
          ...
          <TouchableOpacity onPress={() => console.warn('.replace(Beranda) => belum memiliki function')} activeOpacity={0.9} style={styles.btn_daftar}>
